...
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _get=function(e,t,r){for(var n=!0;n;){var o=e,a=t,u=r;i=c=s=void 0,n=!1,null===o&&(o=Function.prototype);var i=Object.getOwnPropertyDescriptor(o,a);if(void 0!==i){if("value"in i)return i.value;var s=i.get;return void 0===s?void 0:s.call(u)}var c=Object.getPrototypeOf(o);if(null===c)return void 0;e=c,t=a,r=u,n=!0}},_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_baseJs=require("./base.js"),_baseJs2=_interopRequireDefault(_baseJs),_utils=require("./../utils");_utils.attachFakeIDBSymbolsTo("object"==typeof global?global:window);var Batch=function(){function e(t,r){_classCallCheck(this,e),this._transaction=t,this._store=r,this._operations=[],this._errors=[]}return _createClass(e,[{key:"abort",value:function(){this._operations.length=0,this._transaction.abort()}},{key:"get",value:function(e){var t=this;return e?new Promise(function(r,n){var o=t._store.get(e);o.onerror=function(e){return n(e.target.error)},o.onsuccess=function(){return r(o.result)}}):Promise.reject(new Error("Id not provided."))}},{key:"list",value:function(){var e=this;return new Promise(function(t,r){var n=[],o=e._store.openCursor();o.onerror=function(e){return r(e.target.error)},o.onsuccess=function(e){var r=e.target.result;r?(n.push(r.value),r["continue"]()):t(n)}})}},{key:"_schedule",value:function(t,r){var n=this,o={type:t,data:r};return this._operations.push(o),new Promise(function(a,u){var i=e.BATCH_STORE_METHODS[t];try{var s=n._store[i](r);s.onerror=function(e){n._errors.push(e.target.error),u(e.target.error)},s.onsuccess=function(e){return a(o)}}catch(c){c.operation=o,n._errors.push(c),u(event.target.err)}})}},{key:"clear",value:function(){return this._schedule("clear")}},{key:"create",value:function(e){return this._schedule("create",e)}},{key:"update",value:function(e){return this._schedule("update",e)}},{key:"delete",value:function(e){return this._schedule("delete",e)}},{key:"execute",value:function(e){var t=this;return Promise.resolve(e(this)).then(function(e){return new Promise(function(r,n){var o=function(e){return r({result:e,operations:t._operations,errors:t._errors})};t._transaction.onerror=function(r){t._errors=t._errors.concat({type:"error",error:r.target.error}),o(e)},t._transaction.onabort=function(){return o(e)},t._transaction.oncomplete=function(){return o(e)}})})["catch"](function(e){return console.log(e),{result:void 0,operations:t._operations,errors:t._errors.concat(e)}})}}],[{key:"BATCH_STORE_METHODS",get:function(){return{clear:"clear",create:"add",update:"put","delete":"delete"}}}]),e}(),IDB=function(e){function t(e){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this),this._db=null,this.dbname=e}return _inherits(t,e),_createClass(t,[{key:"_handleError",value:function(e){return function(t){var r=new Error(e+"() "+t);throw r.stack=t.stack,r}}},{key:"open",value:function(){var e=this;return this._db?Promise.resolve(this):new Promise(function(t,r){var n=indexedDB.open(e.dbname,1);n.onupgradeneeded=function(t){var r=t.target.result,n=r.createObjectStore(e.dbname,{keyPath:"id"});n.createIndex("id","id",{unique:!0}),n.createIndex("_status","_status"),n.createIndex("last_modified","last_modified");var o=r.createObjectStore("__meta__",{keyPath:"name"});o.createIndex("name","name",{unique:!0})},n.onerror=function(e){return r(e.target.error)},n.onsuccess=function(r){e._db=r.target.result,t(e)}})}},{key:"prepare",value:function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],t=arguments.length<=1||void 0===arguments[1]?null:arguments[1],r=t||this.dbname,n=e?this._db.transaction([r],e):this._db.transaction([r]),o=n.objectStore(r);return{transaction:n,store:o}}},{key:"batch",value:function(e){var t=this;return this.open().then(function(){var r=t.prepare("readwrite"),n=r.transaction,o=r.store,a=new Batch(n,o);return a.execute(e)})}},{key:"clear",value:function(){return this.batch(function(e){return e.clear()}).then(function(e){if(e.errors.length>0)throw e.errors[0]})["catch"](this._handleError("clear"))}},{key:"create",value:function(e){return this.batch(function(t){return t.create(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("create"))}},{key:"update",value:function(e){return this.batch(function(t){return t.update(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("update"))}},{key:"get",value:function(e){return this.batch(function(t){return t.get(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result})["catch"](this._handleError("get"))}},{key:"delete",value:function(e){return this.batch(function(t){return t["delete"](e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("delete"))}},{key:"list",value:function(){return this.batch(function(e){return e.list()}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result})["catch"](this._handleError("list"))}},{key:"saveLastModified",value:function(e){var t=this,r=parseInt(e,10);return this.open().then(function(){return new Promise(function(e,n){var o=t.prepare("readwrite","__meta__"),a=o.transaction,u=o.store;u.put({name:"lastModified",value:r}),a.onerror=function(e){return n(e.target.error)},a.oncomplete=function(t){return e(r)}})})}},{key:"getLastModified",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,r){var n=e.prepare(void 0,"__meta__"),o=n.transaction,a=n.store,u=a.get("lastModified");o.onerror=function(e){return r(e.target.error)},o.oncomplete=function(e){t(u.result&&u.result.value||null)}})})}}]),t}(_baseJs2["default"]);exports["default"]=IDB,module.exports=exports["default"];
